...
• Pure-black AMOLED-true-black UI throughout, so the player disappears
  at the bedside.
• The four noise colors (brown, pink, white, violet) are generated by
  math in real time — no clip on repeat at all.
• The six naturalistic sounds ship as field recordings: rain, ocean,
  thunderstorm, and fireplace as 10-minute clips; fan and dryer as
  ~1.5-minute clips. Not the 30-second snippets other sleep apps
  loop every half-minute.
...
• In-app link to dontkillmyapp.com so you can find the right OEM
  battery-killer toggle for your phone (Samsung, Xiaomi, OnePlus,
  Huawei, etc.).
...
• AMOLED-true-black UI for bedside use.
...
| Does this app offer in-app purchases? | Yes — per-sound one-time $0.99 unlocks, plus a $3.99 all-sounds bundle. | Decided 2026-05-19: 4 free sounds + 6 premium sounds at $0.99 each, with a $3.99 `bundle_all_sounds` SKU added 2026-05-22. |
